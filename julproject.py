...
print('when playing this game you get up to 3 choices each time and have to decide between them by writing either 1, 2 or 3 no other options are available and only one option is correct')
print('.......................')
variable = 1
text = 0
while variable <4>0:
